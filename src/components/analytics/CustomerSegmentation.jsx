...
const customerSegmentationData = [
	...
	{ subject: "Frequência", A: 85, B: 90, fullMark: 150 },
	{ subject: "Recência", A: 65, B: 85, fullMark: 150 },
];
...
const CustomerSegmentation = () => {
	return (
		...
		>
			<h2 className='text-xl font-medium mb-4 text-gray-400'>Segmentação de Clientes</h2>
