	...
	return (
		...
		>
			<div className='flex items-center mb-4'>
				...
				<h2 className='text-xl font-semibold text-gray-100'>Zona de perigo</h2>
			</div>
			<p className='text-gray-300 mb-4'>Exclua permanentemente sua conta e todo o seu conteúdo.</p>
			<button
